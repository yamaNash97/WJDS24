    ...
    <form name="login" action="login" method="POST">
                            <table border="0">
                                <tbody>
                                    <tr>
                                        <td>username</td>
                                        <td><input type="text" name="username" value="" size="30" /></td> <!-- Changed uname to username -->
                                    </tr>
                                    <tr>
                                        <td>password</td>
                                        <td><input type="password" name="password" value="" size="30" /></td> <!-- Changed pass to password -->
                                    </tr>
                                    <tr>
