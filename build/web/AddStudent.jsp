...
<div class="text">
    <center>
    <form name="addstd" action="addstd" method="POST">
                            <table border="0">
                                <tbody>
                                    <tr>
                                        <td>student name</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="sAddress" value="" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>student birth date</td>
                                        <td><input type="date" name="sBirthday" value="" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td><input type="submit" value="add student" name="addstd" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
