    ...
    <form name="addteacher" action="addteacher" method="POST">
                            <table border="0">
                                <tbody>
                                    <tr>
                                        <td>teacher name</td>
                                        <td><input type="text" name="tname" value="" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>teacher certificate</td>
                                        <td><input type="text" name="cer" value="" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>teacher birth date</td>
                                        <td><input type="date" name="date" value="" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td><input type="submit" value="add teacher" name="addteacher" /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
